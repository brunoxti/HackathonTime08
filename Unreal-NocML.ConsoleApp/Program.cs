...
namespace Unreal_NocML.ConsoleApp
{
    class Program
    {
        ...
        private static List<SyntheticTest> GetSyntheticTests()
        {
            return new List<SyntheticTest> {
                new SyntheticTest() { Id = Guid.NewGuid(), Description = "login-clear-pro" },
                new SyntheticTest() { Id = Guid.NewGuid(), Description = "alteracao-dados-clear-pro" },
                new SyntheticTest() { Id = Guid.NewGuid(), Description = "retirada-clear-pro" },
                new SyntheticTest() { Id = Guid.NewGuid(), Description = "envio-ordem-clear-pro" }};
